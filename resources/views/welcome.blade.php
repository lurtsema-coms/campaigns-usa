...
<html class="scroll-smooth" lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="min-h-screen antialiased text-white u-bg-fixed" x-data="{ joeLurtsema: false, brooksPitcher: false, jubileeUnderwood: false, robertYundt: false, isOpenSidebar: false }">
        ...
        <div class="fixed inset-0 z-20 flex min-h-screen p-10 overflow-auto bg-black min-w-screen bg-opacity-85"
            ...
            <div class="m-auto text-black w-full max-w-7xl bg-white border-2 relative rounded-[1.9rem] lg:h-[30rem]"
                ...
                <div class="flex flex-wrap justify-center h-full">
                    <!-- First Div (30%) -->
                    <div class="relative flex w-full max-w-md">
                        <img class="object-contain max-w-xl w-96 sm:relative -bottom-1 -left-24 sm:w-auto lg:absolute" src="{{ asset('frontend/campaign2-modal.png') }}" alt="">
                    </div>
                    <!-- Second Div (70%) -->
                    <div class="flex-grow flex-shrink basis-96 sm:min-w-[35rem] flex flex-col justify-center py-10 px-5 sm:px-16 text-[#001A47] space-y-5">
                        <div>
        ...
        {{-- Navbar --}}
        <div class="sticky top-0 z-10 h-40 p-5 w-ful l u-bg-fixed sm:p-0 sm:relative" id="navbar" data-aos="fade-down">
                ...
                <div class="flex items-center h-full sm:px-12 md:px-20 lg:px-28">
                    ...
                    <div class="fixed top-0 right-0 z-30 p-10 space-y-5 text-gray-600 bg-white h-dvh w-72"
                        ...
                        <div class="flex flex-col space-y-4 text-lg">
                            ...
                            <a class="text-2xl hover:opacity-70" href="">PRICING</a>
