    ...
    <div class="relative px-5 py-12 space-y-12">
        ...
        <div class="mx-auto bg-white border shadow-sm max-w-7xl rounded-xl">
            ...
            <div class="px-5 py-5">
                ...
                >
                    <a wire:navigate href="{{ route('course-item', 1) }}">
                        <div class="pb-5 overflow-hidden border shadow-sm hover:shadow-lg bg-zinc-50 rounded-xl">
                            <div class="h-40">
                            ...
                            <div class="px-5 mt-8 ">
                                ...
                                <div class="flex flex-wrap gap-2 mt-4 text-xs truncate">
