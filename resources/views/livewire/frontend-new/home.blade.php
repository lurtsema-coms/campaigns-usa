    ...
    <div class="relative pt-16 pb-16 mx-auto overflow-hidden lg:pt-5 lg:pb-0 max-w-8xl">
        ...
        <div class="grid lg:grid-cols-2">
            ...
            <div class="flex flex-col justify-center gap-12 px-5 mx-auto"  data-aos="flip-left">
                <div>
                    <h2 class="text-4xl font-bold tracking-wide text-gray-800 sm:text-6xl font-sourceserif" style="text-shadow: 4px 3px rgba(206, 206, 206, 0.6);">Learn from</h2>
                    <h2 class="text-4xl font-bold tracking-wide text-blue-800 sm:text-6xl font-sourceserif" style="text-shadow: 4px 3px rgba(206, 206, 206, 0.6);">an Expert Mentor</h2>
