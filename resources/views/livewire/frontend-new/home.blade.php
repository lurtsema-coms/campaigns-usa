...
<div class="relative">
    ...
    <div class="relative pt-16 pb-16 mx-auto overflow-hidden lg:pt-5 lg:pb-0 max-w-8xl">
        ...
        <div class="grid lg:grid-cols-2">
            ...
            <div class="flex flex-col justify-center gap-12 px-5 mx-auto"  data-aos="flip-left">
                <div>
                    <h2 class="text-4xl font-bold tracking-wide text-gray-800 sm:text-6xl font-sourceserif" style="text-shadow: 4px 3px rgba(206, 206, 206, 0.6);">Lorem, ipsum</h2>
                    <h2 class="text-4xl font-bold tracking-wide text-blue-800 sm:text-6xl font-sourceserif" style="text-shadow: 4px 3px rgba(206, 206, 206, 0.6);">Lorem, ipsum dolor</h2>
                </div>
                <p class="max-w-2xl tracking-wider text-gray-600 sm:text-xl">Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam earum, minima, sapiente aperiam deserunt iure repudiandae aliquid aut, ad architecto laborum. Exercitationem sunt porro quam?</p>
    ...
    >
        ...
        <p class="mx-auto text-2xl font-medium text-center text-white">Notable Campaigns</p>
    ...
    <div class="px-5 py-16 mx-auto max-w-8xl">
        ...
        <div
            ...
            class="grid gap-6 mt-16 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4"
        >
        ...
        <div class="px-5 py-16 mx-auto sm:px-6 sm:py-32 lg:px-8">
            <div class="grid gap-8 mx-auto mb-16 sm:mb-32 md:grid-cols-2 max-w-7xl">
                ...
                <div class="flex items-center">
                    <img src="{{ asset('frontend/politics-talking.jpg') }}" alt="">
                </div>
            </div>
            <div class="grid gap-8 mx-auto md:grid-cols-2 max-w-7xl">
                <div class="flex items-center">
                    <img src="{{ asset('frontend/politics-learning.jpg') }}" alt="">
                </div>
