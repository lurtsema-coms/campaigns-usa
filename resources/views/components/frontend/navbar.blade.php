<div x-data="{ isNavOpen: false }">
    <div class="flex items-center p-5 border-b border-slate-800">
        ...
        <div class="flex-1 relative flex justify-end items-center gap-3">
            ...
            <div class="bg-color-blue py-2 px-4 rounded-lg cursor-pointer transition-all hover:opacity-70">
                <div>
                    Login
                </div>
            </div>
            <div class="min-w-fit bg-color-blue py-2 px-4 rounded-lg cursor-pointer transition-all hover:opacity-70">
                <div>
                    Sign Up
                </div>
            </div>
